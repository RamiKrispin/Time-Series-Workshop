...
knitr::include_graphics("/Users/ramikrispin/R/packages/Slides/Time-Series-Workshop/images/Time Series with R.png")
```
...
knitr::include_graphics("/Users/ramikrispin/R/packages/Slides/Time-Series-Workshop/images/Time Series Analysis Workflow.png")
```
...
```{r echo=FALSE, out.width="850px"}
knitr::include_graphics("/Users/ramikrispin/R/packages/Slides/Time-Series-Workshop/images/TSstudio Structure.png")
```
...
```{r echo=FALSE, out.width="650px"}
knitr::include_graphics("/Users/ramikrispin/R/packages/Slides/Time-Series-Workshop/images/linear models.png")
```
...
```{r regression, echo=FALSE, include = F}
library(shiny)
...
inputPanel(checkboxGroupInput(inputId = "features", label = "Select the Model Features",
...
```{r arima-child, child = "time-series-workshop-arima.Rmd", include=FALSE}
```
